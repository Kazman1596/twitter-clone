        ...
        <div className='xl:w-[600px] hidden lg:inline ml-8 space-y-5'>
            <div className='w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50'>
                <div className='flex items-center p-3 rounded-full bg-red-300 relative'>
                    ...
                    <input className='absolute inset-0 rounded-full pl-11 border-gray-500 bg-gray-100 text-gray-700 focus:shadow-lg focus:bg-white' type='text' placeholder='Search Twitter' />
                </div>
            </div>
            ...
            <div className='sticky top-16 text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:w-[75%]'>
                ...
                <button onClick={()=>setFollowNum(followNum + 3)}  className='text-blue-300 pl-4 pb-3 hover:text-blue-400'>Show More</button>
            </div>
        </div>
